...
sudo $OVS_HOME/ovs-ofctl add-flow br0 ip,nw_src=10.0.0.2,nw_dst=10.0.0.10,actions=enqueue:17:0x12
sudo $OVS_HOME/ovs-ofctl add-flow br0 ip,nw_src=10.0.0.10,nw_dst=10.0.0.2,actions=output:16

sudo $OVS_HOME/ovs-ofctl add-flow br0 ip,nw_src=10.0.0.3,nw_dst=10.0.0.10,actions=enqueue:17:0x13
